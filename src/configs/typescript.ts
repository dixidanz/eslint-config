...
export async function typescript(
  ...
  function makeParser(typeAware: boolean, files: string[], ignores?: string[]): TypedFlatConfigItem {
    return {
      ...
      name: `dixidan/typescript/${typeAware ? 'type-aware-parser' : 'parser'}`
    }
  }

  return [
    {
      name: 'dixidan/typescript/setup',
      plugins: {
        ts: pluginTs as any
      }
    },
    ...
    ...isTypeAware
      ? [{
          ...
          name: 'dixidan/typescript/rules-type-aware',
          rules: {
            ...typeAwareRules,
            ...overridesTypeAware
          }
